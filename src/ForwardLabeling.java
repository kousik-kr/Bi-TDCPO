...
public class ForwardLabeling implements Callable<List<Label>>{
	private int destination;
	private Label topLabel;
	private double budget;
	private boolean master = false;
	
	public ForwardLabeling(int destination, double b, Label label){
...
//		}
		...
		List<ForwardLabeling> labelQueue = new ArrayList<ForwardLabeling>();
			...
			if(Graph.get_node(j).isFeasible() && !topLabel.getVisited(j)) {
				...
				if(arrivalTime!=null) {
					...
					if(j==destination) {
						...
						ForwardLabeling newthread = new ForwardLabeling(destination, budget, newLabel);
